...
export default function Profile() {
  ...
  const age = member.birthDate ? Math.floor((Date.now() - new Date(member.birthDate)) / (365.25 * 24 * 3600 * 1000)) : null
  ...
  return (
    <div className="overflow-y-auto h-full bg-gray-50 pb-8 animate-fade-in">
      ...
      <div className="bg-dark flex flex-col items-center gap-3 overflow-hidden relative">
        ...
        {/* Actions rapides */}
        {(member.phone || member.email || whatsappHref || member.instagramUsername || member.facebookUrl) && (
      ...
      <div className="px-4 py-5 space-y-4">
        ...
        <Card title="Informations">
          <div className="divide-y divide-gray-50">
            ...
            {!member.birthDate && !member.occupation && !member.city && !member.phone && !member.email && (
        ...
        {/* Réseaux sociaux */}
        {(canEdit || member.facebookUrl || member.instagramUsername || member.whatsappNumber) && (
              ...
              <div className="space-y-3">
                ...
                {member.email && (
                  <button onClick={handleGenerateInvite}
                    ...
                    Regénérer le lien d'invitation
                  </button>
                )}
              </div>
            )}
