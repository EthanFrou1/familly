    ...
    <div className="fixed inset-0 z-50 flex items-end" onClick={onClose}>
      ...
      >
        ...
        <div className="rounded-2xl bg-gray-50 p-4 space-y-2.5">
          ...
          <LegendRow color="bg-amber-300" label="Proche (génération voisine ou même département)" />
          <LegendRow color="bg-red-400" label="Différent" />
          <LegendRow color="bg-gray-200" label="Non défini (infos manquantes pour comparer)" />
