...
export default function PhotoDeleteModal({ open, loading, onClose, onRemoveFromAlbum, onDeletePermanently }) {
  if (!open) return null
  return createPortal(
    <div className="fixed inset-0 z-[120] flex items-end justify-center sm:items-center">
      ...
      <div className="relative bg-white rounded-t-3xl sm:rounded-2xl w-full sm:max-w-sm animate-slide-up">
        <div className="px-5 pt-6 pb-3 text-center border-b border-gray-100">
          <h2 className="text-base font-bold text-gray-900">Que faire de cette photo ?</h2>
        </div>
