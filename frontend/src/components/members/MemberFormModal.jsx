...
export default function MemberFormModal({ open, onClose, onSubmit, initial = null }) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[60] flex flex-col justify-end" style={{ touchAction: 'pan-y' }}>
      ...
      <div className="relative bg-white rounded-t-3xl animate-slide-up max-h-[90vh] w-full flex flex-col overflow-x-hidden" style={{ touchAction: 'pan-y' }}>
...
const inputCls = 'w-full rounded-xl border border-gray-200 bg-gray-50 px-3.5 py-2.5 text-sm text-gray-900 focus:border-primary focus:outline-none focus:bg-white transition-colors'
